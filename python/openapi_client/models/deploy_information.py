...
class DeployInformation(object):
    ...
    def __init__(self, age=None, start=None, local_vars_configuration=None):  # noqa: E501
        """DeployInformation - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeployInformation):
            return False
