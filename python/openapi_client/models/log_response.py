...
class LogResponse(object):
    ...
    def __init__(self, data=None, local_vars_configuration=None):  # noqa: E501
        """LogResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this LogResponse.  # noqa: E501


        :return: The data of this LogResponse.  # noqa: E501
        :rtype: Log
        """
        return self._data
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LogResponse):
            return False
