...
void Subsystem::setCreatedAt(const utility::string_t& value)
{
    m_CreatedAt = value;
...
utility::string_t Subsystem::getUpdateAt() const
{
    return m_UpdateAt;
}

void Subsystem::setUpdateAt(const utility::string_t& value)
{
    m_UpdateAt = value;
    m_UpdateAtIsSet = true;
}

bool Subsystem::updateAtIsSet() const
{
    return m_UpdateAtIsSet;
}

void Subsystem::unsetUpdateAt()
{
    m_UpdateAtIsSet = false;
}
}
