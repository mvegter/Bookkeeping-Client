...
pplx::task<std::shared_ptr<DataResponse>> DefaultApi::createLog() const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("DefaultApi->createLog does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("DefaultApi->createLog does not consume any supported media type"));
    }
    ...
    {
        std::shared_ptr<DataResponse> localVarResult(new DataResponse());
...
pplx::task<std::shared_ptr<DataResponse>> DefaultApi::getLogById(int64_t id) const
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("DefaultApi->getLogById does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("DefaultApi->getLogById does not consume any supported media type"));
    }
