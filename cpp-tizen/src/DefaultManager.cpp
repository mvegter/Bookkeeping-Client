	...
	void(* voidHandler)())
{
	...
	= reinterpret_cast<void(*)(DataResponse, Error, void* )> (voidHandler);
	...
	if (code >= 200 && code < 300) {
		...
		if (isprimitive("DataResponse")) {
			pJson = json_from_string(data, NULL);
			jsonToValue(&out, pJson, "DataResponse", "DataResponse");
			json_node_free(pJson);

			if ("DataResponse" == "std::string") {
...
bool DefaultManager::createLogAsync(char * accessToken,
...
bool DefaultManager::createLogSync(char * accessToken,
...
bool DefaultManager::getLogByIdAsync(char * accessToken,
	long long id, 
	void(* handler)(DataResponse, Error, void* )
	, void* userData)
{
...
bool DefaultManager::getLogByIdSync(char * accessToken,
	long long id, 
	void(* handler)(DataResponse, Error, void* )
	, void* userData)
{
