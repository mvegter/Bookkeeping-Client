...
#ifndef _ArrayOfLogsResponseMeta_H_
#define _ArrayOfLogsResponseMeta_H_
...
class ArrayOfLogsResponseMeta : public Object {
public:
	/*! \brief Constructor.
	 */
	ArrayOfLogsResponseMeta();
	ArrayOfLogsResponseMeta(char* str);
...
#endif /* _ArrayOfLogsResponseMeta_H_ */
